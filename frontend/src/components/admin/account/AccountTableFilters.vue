<template>
  <div class="account-table-filters">
    ...
    <Select :model-value="filters.status" class="account-filter-select" :options="sOpts" @update:model-value="updateStatus" @change="$emit('change')" />
    ...
    <Select :model-value="filters.group" class="account-filter-select" :options="gOpts" @update:model-value="updateGroup" @change="$emit('change')" />
  </div>
</template>

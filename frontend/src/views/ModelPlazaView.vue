<template>
  ...
  <div v-else class="smv3-public-page">
    ...
    <main class="smv3-public-main">
      <section class="smv3-public-hero">
        <div>
          <div class="smv3-page-kicker">SMIREL MODEL CATALOG</div>
          <h1>{{ copy.title }}</h1>
          <p>{{ copy.description }}</p>
        </div>
        <aside class="smv3-public-hero-aside">
          <span>API BASE</span>
          <code>{{ apiBase }}</code>
          <span style="margin-top: 12px">COMPATIBILITY</span>

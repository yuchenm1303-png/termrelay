...
const (
	AdminComplianceVersion        = "v2026.09.16"
	...
	AdminComplianceDocumentURLZH  = "https://github.com/yuchenm1303-png/termrelay/blob/main/docs/legal/admin-compliance.zh.md"
	AdminComplianceDocumentURLEN  = "https://github.com/yuchenm1303-png/termrelay/blob/main/docs/legal/admin-compliance.en.md"
	AdminComplianceAckPhraseZH    = "我已阅读、理解并同意 Muxway 管理员部署与运营确认"
	AdminComplianceAckPhraseEN    = "I have read, understood, and agree to the Muxway Administrator Deployment and Operation Acknowledgement"
